...
import { Skill, SkillCategory, SkillTier } from '@shared/models/skill.model';
  ...
  readonly categories = signal<SkillCategory[]>([
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'Kafka', iconSrc: 'assets/icons/skills/apachekafka-original.svg' },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'Cursor', iconSrc: 'assets/icons/skills/cursor-original.svg', tier: 'core' },
      ],
    },
  ]);
}
